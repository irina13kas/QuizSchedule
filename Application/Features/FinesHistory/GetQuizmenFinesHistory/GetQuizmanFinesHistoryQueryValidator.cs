...
{
    public class GetQuizmanFinesHistoryQueryValidator : AbstractValidator<GetQuizmanFinesHistoryQuery>
    {
        public GetQuizmanFinesHistoryQueryValidator()
        {
            ...
            RuleFor(x => x.QuizmanId)
                .NotEmpty().WithMessage("Квизмен Id обязателен");
        }
    }
}
